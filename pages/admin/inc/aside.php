<div class="aside">
    <div class="profile">
      <?php if(!empty($_SESSION['user_inf']['avatar'])) { ?>
      <img class="avatar" src="<?php echo $_SESSION['user_inf']['avatar']; ?>">
      <?php }else { ?>
      <img class="avatar" src="/assets/img/default.png">
      <?php } ?>
      <h3 class="name"><?php echo $_SESSION['user_inf']['slug']; ?></h3>
    </div>
    <ul class="nav">
      ...
      <li <?php if(in_array($active,$actives)) { ?> class="active" <?php } ?>>
        ...
        <ul id="menu-posts" class="collapse <?php if(in_array($active,$actives)) { ?> in <?php } else { ?> collapse <?php } ?>" >
      ...
      <li <?php if(in_array($active,$cogs)) { ?> class="active" <?php } ?>> 
        ...
        <ul id="menu-settings" class="collapse <?php if(in_array($active,$cogs)) { ?> in <?php } else { ?> collapse <?php } ?>">
